                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form action="{{ route('update.details') }}" method="post">
                                            ...
                                            @csrf
                                        <h5>Name</h5>
                                        <input class="form-control form-control-lg"  value="{{ $userDetails->name }}" name="name"  type="text" placeholder="Name" aria-label=".form-control-lg example">
                                        <h5 class="p-t-20">Job Title</h5>
                                        <input class="form-control form-control-lg" value="{{ $userDetails->job_title }}" name="job_title" type="text" placeholder="Job Title" aria-label=".form-control-lg example">
                                        <h5 class="p-t-20">Bio</h5>
                                        <input class="form-control form-control-lg p-b-150" value="{{ $userDetails->bio }}" name="bio" type="text" placeholder="Tell us about you" aria-label=".form-control-lg example">
                                        <!--<h5 class="p-t-20">Email Address</h5>
                                        <div class="form-group">
                                            <input type="email" placeholder="name@domain.com" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                            <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                                          </div>
                                        <h5 class="p-t-0">Phone Number</h5>
                                        <input class="form-control form-control-lg" type="text" placeholder="" aria-label=".form-control-lg example">-->
                                        <button class="btn btn-primary m-t-30" type="submit" name="submit" >Update</button>
