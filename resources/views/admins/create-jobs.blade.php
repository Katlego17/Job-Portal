          ...
          @endif
            ...
            <div class="form-group">
              ...
              <select name="salary" class="selectpicker border rounded form-control" id="job-type" data-style="btn-black" data-width="100%" data-live-search="true" title="Select Salary">
                ...
                <option value="R20k  - R30k">R20k - R30k</option>
                <option value="R30k - R50k">R30k - R50k</option>
                <option value="R50k - R70k">R50k - R70k</option>
                <option value="R70k  - R100k">R70k - R100k</option>
                <option value="R100k - R150k">R100k - R150k</option>
              </select>
            </div>
