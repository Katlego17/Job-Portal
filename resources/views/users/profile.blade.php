                                        ...
                                        <div class="d-md-flex align-items-center">
                                            <div class="text-center text-sm-left ">
                                                <div class="avatar avatar-image" style="width: 150px; height:150px">
                                                    <img src="{{ asset('assets/images_users/'.$profile->image.'') }}" alt="">
                                                </div>
                                            </div>
                                            <div class="text-center text-sm-left m-v-15 p-l-30">
                                                <h2 class="m-b-5">{{ $profile->name }}</h2>

                                                <p class="text-dark m-b-20">{{ $profile->job_title }}</p>
                                                <a href="{{ asset('assets/cvs/'.$profile->cv.'') }}" target="_blank"><button class="btn btn-primary btn-tone">Download CV</button></a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                            ...
                                            <div class="col">
                                                <!--<ul class="list-unstyled m-t-10">
                                                    <li class="row">
                                                        ...
                                                        <p class="col font-weight-semibold"> johndoe@gmail.com</p>
                                                    </li>
                                                    <li class="row">
                                                        <p class="col-sm-4 col-4 font-weight-semibold text-dark m-b-5">
                                                        ...
                                                        <p class="col font-weight-semibold"> +27-123-1234</p>
                                                    </li>
                                                    <li class="row">
                                                        ...
                                                        <p class="col font-weight-semibold"> Region</p>
                                                    </li>
                                                </ul>-->
                                        ...
                                        <div class="m-t-20">
                                            <div class="media m-b-30">
                                                ...
                                                <div class="media-body m-l-20">
                                                    <h6 class="m-b-0">MSt in Social Innovation, Cambridge University
                                                    </h6>
